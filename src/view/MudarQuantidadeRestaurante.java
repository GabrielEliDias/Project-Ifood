 ...
 * @author gabri
 */
public class MudarQuantidadeRestaurante extends javax.swing.JFrame {

    /**
     * Creates new form NovaSenha
     */
    public MudarQuantidadeRestaurante() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Diga a nova quantidade");

        botaoConfirmarNovaSenha.setFont(new java.awt.Font("Franklin Gothic Medium", 0, 13)); // NOI18N
        botaoConfirmarNovaSenha.setText("Confirmar quantidade");
        ...
        jLabel13.setText("Quantidade anterior");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MudarQuantidadeRestaurante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MudarQuantidadeRestaurante().setVisible(true);
            }
        });
    }
